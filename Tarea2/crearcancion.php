...
if ($_POST){
    $buscar_art="SELECT * FROM artistas WHERE IDpersona = ?";
    $sql_art=$bd->prepare($buscar_art);
    $sql_art->execute(array($_SESSION['ID']));
    $resultado=$sql_art->fetch();
    $nombre_cancion = $_POST["nombre_cancion"];
    $duracionc = $_POST["duracion"];
    $generoc = $_POST["genero"];
    ...
    $agregarc->execute(array($nombre_cancion,$_SESSION["name"],$duracionc,$generoc, $resultado["IDartista"]));
    echo 'Cancion creada!';
}
?>
<!DOCTYPE html>
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="todotodo">
    ...
    <div class="w3-container">
    <h1><b>¿Qué canción crearás hoy?</b></h1>
    </div>
  </header>
  <!-- First Photo Grid-->
  <div class="w3-row-padding">
	...
	<div class="form-group input-group justify-content-center">
        ...
        <input name="nombre_cancion" class="form-control" placeholder="Nombre de canción" type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-clock-o"></i> </span>
		 </div>
        <input name="duracion" class="form-control" placeholder="Duracion en minutos" type="int">
        </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-music"></i> </span>
		</div>
        <input name= "genero" class="form-control" placeholder="Genero" type="text">
    </div> <!-- form-group// -->   
	<div class="form-group">
        <button type="submit" class="btn btn-primary btn-block"> Crear canción  </button>
    </div> <!-- form-group// -->     
      </div>
    </div>
  </div>
